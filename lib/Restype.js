...
class Restype {
    constructor(httpConfig, container) {
        ...
        this.routeForMethod = (controllerItem, routeItem) => {
            ...
            return (req, res) => __awaiter(this, void 0, void 0, function* () {
                try {
                    if (authentication && !(yield this.authenticator.authenticate(authentication, req))) {
        ...
        this.authenticator = new Authentication_1.Authenticator();
        this.app = express();
    ...
    static get auth() {
        return Authentication_1.globalAuthentication;
    }
    static set auth(restAuthentication) {
        restAuthentication = restAuthentication || {};
        Authentication_1.globalAuthentication.basicAuthentication = restAuthentication.basicAuthentication;
        Authentication_1.globalAuthentication.jwtAuthentication = restAuthentication.jwtAuthentication;
        Authentication_1.globalAuthentication.jwtSecret = restAuthentication.jwtSecret;
    }
